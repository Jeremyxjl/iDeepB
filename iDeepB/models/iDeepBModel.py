...
class iDeepB(nn.Module):
    def __init__(self,dropOut, control):
        ...
        self.Res1_conv1 = nn.Conv1d(in_channels=4,out_channels=128,kernel_size=5, padding='same')
        ...
        self.Res1_conv3 = nn.Conv1d(4, 64, 1)
    ...
    def forward(self, x):
        ...
        if not self.control:
            ...
            # print("Control:", output_T.shape, output_C.shape, x_w.shape)
